...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001687768591').split()]
...
SUPPORT_CHAT_ID = int(environ.get('SUPPORT_CHAT_ID', '-1001541997441'))
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/Sai_Moviezz")
VERIFY2_URL = environ.get('VERIFY2_URL', "")
VERIFY2_API = environ.get('VERIFY2_API', "")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'gplinks.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '0df85472742ce618c3652eb5136d2b51be322e04')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Sai_Moviezz_Update')
